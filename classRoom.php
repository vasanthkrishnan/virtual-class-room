...
<div class=Wrapper2>
    ...
    <div class="user_details cloumn">
        ...
        <div class="assignment_box">
            ...
            <a href="library/index.html" id="assignmentBtn"><i class="fas fa-book-open" style='margin-right: 5px;'></i>Library</a>

            <a href="Attendance/index.php" id="assignmentBtn"><i class="fas fa-user" style='margin-right: 5px;'></i>Attendance</a>

            <a href="onlineedu/courses.php" id="assignmentBtn"><i class="fas fa-globe" style='margin-right: 5px;'></i>Courses</a>
